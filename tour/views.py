...
nightsmin = {}
nightsmax = {}
for departure, description in departures.items():
    tourcount[departure] = 0
    pricemin[departure] = 10000000000
    pricemax[departure] = 0
...
for id,tour in tours.items():
    ...
    if tour['price'] > pricemax[tour['departure']]:
        pricemax[tour['departure']] = tour['price']
    if tour['nights'] < nightsmin[tour['departure']]:
        nightsmin[tour['departure']] = tour['nights']
